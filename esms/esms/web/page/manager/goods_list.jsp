...
<body>
	...
	<script type="text/javascript">
		...
		function edit(id) {
			window.open("manager/goods_edit?id="+id, "addGoods", "height=400,width=500,top="+(screen.availHeight-500)/2+",left="+(screen.availWidth-500)/2+",toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no");
		}
